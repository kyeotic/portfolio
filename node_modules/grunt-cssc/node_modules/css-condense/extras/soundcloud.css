...
ul.bullet li, .jobs_detail .jdesc ul li { margin: 0 0 0.5em 0; }
...
.close { position: absolute; right: 4px; z-index: 10; display: block; margin: 0px 0px 0px 0px; width: 12px; height: 15px; text-indent: -9999px; background-image: url(/images/elements.png?unicorn28); background-position: -21px -260px; }
...
a.back-to-profile { font-size: 12px; line-height: 12px; color: #333333; padding-left: 16px; background-image: url(/images/icons_mini.png?unicorn28); background-position: -80px -758px; background-repeat: no-repeat; }
...
#header #logo { background: url(/images/soundcloud-logo.png?unicorn28); width: 90px; height: 47px; display: block; text-indent: -9999px; position: absolute; top: 4px; left: 25px; margin: 3px 0 0 0px; outline: 0; }
...
.actions .mute-user-wrapper a.mute-user span, .actions .mute-user-wrapper a.unmute-user span { font-size: 11px; background-image: url(/images/elements.png?unicorn28); background-position: 0px -443px; background-repeat: no-repeat; padding: 0 0 0 17px; outline: 0; color: #777777; }
...
.actions .pl-button { white-space: nowrap; font-size: 10px; line-height: 21px; color: #333333; border-right: 1px #cccccc solid; background-image: url(/images/icons_mini.png?unicorn28); background-repeat: no-repeat; }
...
.action-overlay .shortenable .nowidgets, .action-overlay .embed-code-wrapper .nowidgets { float: left; padding-left: 9px; font-size: 11px !important; margin-right: 6px; line-height: 16px; color: #111111; background-image: url(/images/icons_mini.png?unicorn28); background-repeat: no-repeat; background-position: -89px -1557px; }
...
.blocking-user a { color: #333333; background-image: url(/images/elements.png?unicorn28); background-position: 0px -443px; background-repeat: no-repeat; padding-left: 12px; }
...
a.big-action-button.social-connection span.icon { width: 24px; height: 24px; background-repeat: no-repeat; background-position: 0px 0px; margin-right: 8px; float: left; }
...
a.big-action-button.facebook-signin span.icon { width: 24px; height: 24px; background: url(/images/facebook_signin.png?unicorn28); background-repeat: no-repeat; background-position: 0px 0px; margin-right: 8px; float: left; }
...
#edit-url { padding-right: 18px; margin-right: 5px; background-color: #ffffcc; background-image: url(/images/icons_mini.png?unicorn28); background-position: 100% -1373px; background-repeat: no-repeat; display: inline-block; }
...
.connect-facebook small { font-size: 10px; float: left; margin: -1px -5px 0 8px; padding-bottom: 1px; width: 155px; text-align: left; line-height: 1.2em !important; color: #999999; }
.connect-facebook small.narrower { width: 120px; }
.connect-facebook small a { font-size: 10px !important; display: inline !important; text-align: left; color: #999999 !important; border: 0 !important; padding: 0 !important; margin: 0 !important; }
.connect-facebook small a:hover { color: #666666 !important; }
...
#user-tabs .user-rss-feed a { position: relative; float: right; width: 20px; height: 20px; background-image: url(/images/icons_mini.png?unicorn28); background-position: -76px -2088px; text-indent: -9999px; z-index: 10; margin: -39px 0px 0px; padding: 0px; }
...
body.full-stats .switch .plays, body.full-stats .switch .comments, body.full-stats .switch .favorites, body.full-stats .switch .downloads, body.full-stats .switch .clicks { padding-left: 15px; background-image: url(/images/elements.png?unicorn28); background-position: -339px 0px; background-repeat: no-repeat; }
...
body.full-stats ol.stats-tracks li.stats-item { list-style-position: inside; padding: 5px 0 0 30px; position: relative; border-top: 1px #eeeeee solid; font-size: 12px; line-height: 19px; background-image: url(/images/stats/bg.png?unicorn28); background-position: -796px -705px; background-repeat: no-repeat; }
...
#spotlight-form-wrapper #spotlight-form-wrapper-inner .spotlight-selected-item-list li .remove-track { right: 0px; display: block; height: 17px; width: 21px; position: absolute; top: 5px; text-indent: -9999px; background-image: url(/images/elements.png?unicorn28); background-repeat: no-repeat; background-position: -18px -263px; }
...
#search_spotlight, #type-ahead-search { background: url(/images/icons_mini.png?unicorn28) no-repeat 380px -1675px, url(/images/horizontal_repeat_better.png?unicorn28) repeat-x 0px -37px; background-color: white; padding: 4px 6px; color: #333333; cursor: text; margin-bottom: 7px; }
#search_spotlight.blank, #type-ahead-search.blank { color: #999999; }

#type-ahead-search { background: url(/images/icons_mini.png?unicorn28) no-repeat 239px -1675px, url(/images/horizontal_repeat_better.png?unicorn28) repeat-x 0px -36px !important; }
...
.cc { margin-right: 5px; padding: 3px 0 3px 18px; background-image: url(/images/cc_small.png?unicorn28); background-repeat: no-repeat; background-position: 0px -153px; }
...
#license.product-pages a.cc { background-image: url(/images/cc_medium.png?unicorn28); background-repeat: no-repeat; background-position: 1px 0px; padding-left: 25px; }
...
.report-copyright-infringement { display: inline; background-image: url(/images/elements.png?unicorn28); background-position: -6px -454px; background-repeat: no-repeat; padding: 0 0 0 6px; outline: 0; color: #333333; }
.report-copyright-infringement:hover { color: #ff6600 !important; }

.rtt-sidebar { display: block; margin: 20px 0 30px 0; font-size: 11px; background-image: url(/images/elements.png?unicorn28); background-position: 0px -441px; background-repeat: no-repeat; padding: 0 0 0 17px; outline: 0; color: #777777; }
...
h3.cc { padding: 5px 0px 5px 35px; margin: 0 0 2px 0; background-image: url(/images/cc_medium.png?unicorn28); background-repeat: no-repeat; background-position: -1px -112px; }
...
#volume-control #volume-control-wrapper #volume-control-handle { background-image: url(/images/volume_control.png?unicorn28); background-position: -146px 0px; background-repeat: no-repeat; height: 17px; width: 25px; position: absolute; top: 42px; left: 3px; cursor: pointer; }
...
body#overview #overview-list li .type, body#overview #overview-list li .type-timed-comment { margin: 0 0 0 0; background-image: url(/images/list_items.png?unicorn28); background-repeat: no-repeat; background-position: 0 -195px; padding: 3px 0 0 25px; border-bottom: 1px #cccccc solid; }
...
body#overview #overview-list li .dashboard-item { margin: 0px 0px 0 78px; padding: 7px 40px 0px 4px; border-bottom: 2px solid white; position: relative; background-image: url(/images/dashboard_bg.png?unicorn28); background-position: top right; background-repeat: repeat-y; }
...
.dashboard-item .private, .track-title .private { font-size: 10px; padding: 1px 5px 0 20px !important; color: white; white-space: nowrap; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px; background-color: #777777; background-image: url(/images/icons_mini.png?unicorn28); background-repeat: no-repeat; background-position: -80px -1539px !important; }
...
#comments-list li.comment { position: relative; padding: 10px 0 0 7px; margin: 0 0 0 0; border-bottom: 1px #e5e5e5 solid; min-height: 57px; background-image: url(/images/dashboard_bg.png?unicorn28); background-position: top right; background-repeat: repeat-y; }
...
#gsfn ul.gsfn_topic_list li { margin: 0 0 0.5em 17px; list-style-image: url(/images/bullet.png?unicorn28); }
...
body#pages.copyright .content-item, body#pages.copyright-report .content-item, body#pages.copyright_report_form .content-item { padding: 30px 0 0 0; margin: 30px 0 0 0; border-top: 1px #cccccc solid; }
...
body#pages.copyright .highlight, body#pages.copyright-report .highlight, body#pages.copyright_report_form .highlight { font-style: normal; font-weight: bold; color: #ff6600; }
...
body#pages.copyright #resources li, body#pages.copyright-report #resources li, body#pages.copyright_report_form #resources li { padding: 0.5em 0; }
body#pages.copyright .context-item h3 a, body#pages.copyright-report .context-item h3 a, body#pages.copyright_report_form .context-item h3 a { color: #0066cc; font-size: inherit; }
...
body#pages.sounds #main-wrapper #main-wrapper-inner #soundpage #primary .social-sharing { color: #999999; padding-top: 10px; position: relative; text-align: left; border-top: 1px solid #e3e3e3; }
...
body#pages.sounds #main-wrapper #main-wrapper-inner #soundpage #secondary .peep-row .peep-description h3 { color: #0066cc; line-height: 0.9em; }
body#pages.sounds #main-wrapper #main-wrapper-inner #soundpage #secondary .peep-row .peep-description h4 { color: #999999; font-size: 12px; padding-right: 64px; }
...
#ipadWrapper #ipadOverlay .social-sharing { color: #999999; }
...
@media (min-width: 1227px) { html body#sessions.new #main-wrapper-inner { width: 1226px; }
  ...
  html body#sessions.new #main-wrapper-inner .epic#banner li#create { width: 347px; padding-right: 60px; margin-right: 65px; background: url(/images/homepage/guitar_l.jpg?unicorn28) no-repeat 0px 100%; padding-bottom: 210px; }
  ...
  html body#sessions.new #main-wrapper-inner .epic#banner li#share { width: 303px; margin-right: 70px; padding-bottom: 140px; background: url(/images/homepage/apps_l.jpg?unicorn28) no-repeat 0px 125px; }
  ...
  html body#sessions.new #main-wrapper-inner .epic#banner li#connect { width: 348px; margin-right: 0; background: url(/images/homepage/waveform_l.jpg?unicorn28) no-repeat 0px 120px; padding-bottom: 160px; }
...
body#sessions.new .epic#intro .epic-inner .action-buttons-wrapper .action { margin-top: 0px; }
...
body#sessions.new .epic#banner li#create { width: 307px; margin-right: 45px; padding-bottom: 188px; background: url(/images/homepage/guitar.jpg?unicorn28) no-repeat 0px 100%; }
...
body#sessions.new .epic#banner li#share { width: 288px; padding-bottom: 140px; background: url(/images/homepage/apps.jpg?unicorn28) no-repeat 0px 125px; margin-right: 15px; }
body#sessions.new .epic#banner li#connect { margin-right: 0; width: 307px; padding-bottom: 140px; background: url(/images/homepage/waveform.jpg?unicorn28) no-repeat 0px 120px; }
...
body#pages.tour #main-wrapper-inner { width: 930px; background: none; }
...
body#dashboard ul#dashboard-select li .expand { display: block; cursor: pointer; text-indent: -9000px; background-image: url(/images/elements.png?unicorn28); background-position: 0 -610px; height: 20px; width: 20px; margin: 3px 0px 0px 4px; position: absolute; right: 0; top: 7px; }
...
body#dashboard ul#overview-list li.story .heading { margin: 0px; padding: 4px 22px 4px 24px; white-space: nowrap; overflow: hidden; border-bottom: 1px #cccccc solid; background-image: url(/images/elements.png?unicorn28); background-repeat: no-repeat; text-overflow: ellipsis; }
...
.dashboard-welcome.v2 .welcome .welcome-upload .welcome-actions .welcome-upload-button { background-image: url(/images/welcome_upload.png?unicorn28); border-right: 1px #eeeeee solid; }
...
body#client_applications.new .screenshot-upload a.remove-btn, body#client_applications.edit .screenshot-upload a.remove-btn { display: block; height: 17px; outline: 0px; text-indent: -9999px; width: 20px; float: left; background-color: #e3e3e3; background-image: url(/images/elements.png?unicorn28); background-position: -18px -260px; background-repeat: no-repeat; outline: 0; -moz-border-radius: 4px; border-radius: 4px; -webkit-border-radius: 3px; zoom: 1; }
...
body#pages.developers-manifesto .manifesto .signature a { display: block; width: 285px; float: left; text-align: center; padding: 60px 0 20px 0; background-image: url(/images/manifesto.png?unicorn28); color: #333333; }
...
#pages.tour.full-width #tour-header-wrapper .tour-header-wrapper-inner { border: 1px solid #b6cee6; padding: 0 0px 0 0px; background: white; height: 560px; overflow: hidden; }
#pages.tour.full-width #tour-header-wrapper .tour-header-wrapper-inner ul.context-switch { padding: 14px 20px; margin: 0px; position: relative; background-color: white; background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, white), color-stop(85%, white), color-stop(100%, #f7f7f7)); background: -moz-linear-gradient(top, white 0%, white 85%, #f7f7f7 100%); }
...
#pages.tour.full-width .tour-header ul { position: relative; height: 320px; margin: 0 -20px 0 -20px; padding: 0 0px 0 20px; background: white; background: rgba(255, 255, 255, 0.9); filter: alpha(opacity=90); -ms-filter: "alpha(opacity=90)"; }
...
#pages.tour.full-width h3.app-spotlight { padding: 0px 7px; margin: 0 0 7px 0; width: 269px; color: #777777; }
...
#pages.tour.full-width .tour-teaser .col { width: 295px; padding: 20px 10px 0 10px; background: none; float: left; position: relative; }
...
#pages.tour.full-width .tour-teaser .col ul li { margin: 0 0 20px; padding: 20px 20px 10px 20px; -webkit-box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3); -moz-box-shadow: 0px 0px 2px rgba(0, 0, 0, 0.3); border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px; width: 255px; background-color: white; background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, white), color-stop(85%, white), color-stop(100%, #f7f7f7)); background: -moz-linear-gradient(top, white 0%, white 85%, #f7f7f7 100%); zoom: 1; }
...
#pages.tour.full-width .tour-teaser .col ul li.cc a { color: #333333; display: block; }
#pages.tour.full-width .tour-teaser .col ul li.cc a:hover { color: #ff6600; }
...
#pages.tour.full-width .tour-teaser .col ul li.group a.group span { position: absolute; left: 10px; top: 10px; background: #ff6600; display: inline; color: white; border-radius: 14px; -webkit-border-radius: 14px; -moz-border-radius: 14px; padding: 1px 10px; }
#pages.tour.full-width .tour-teaser .col ul li.group div { float: left; width: 150px; margin: -10px -10px -10px 0; padding: 0px 0 0 0; line-height: 1.3em; }
...
#pages.tour.full-width .tour-teaser .col ul li.small-app p { clear: left; border-top: 1px solid #eeeeee; font-size: 12px; line-height: 1.3em; margin: 12px 0 7px 0; padding-top: 10px; }
...
#pages.tour.full-width .tour-teaser .col ul li h3 a.meet span { position: absolute; left: 10px; bottom: 10px; background: #0066cc; display: inline; color: white; border-radius: 14px; -webkit-border-radius: 14px; -moz-border-radius: 14px; padding: 1px 10px; }
#pages.tour.full-width .tour-teaser .col ul li h3 a.meet:hover span { background-color: #ff6600; }
#pages.tour.full-width .tour-teaser .col ul li h3.user-name { background-color: #f8f8f8; background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #eeeeee), color-stop(0%, #eeeeee), color-stop(8%, white)); background: -moz-linear-gradient(top, #eeeeee 0%, #eeeeee 0%, white 8%); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#efefef', endColorstr='#fcfcfc'); -ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr='#efefef', endColorstr='#fcfcfc')"; zoom: 1; margin: 0px -20px 0px -20px; padding: 20px 20px 10px; }
...
#pages.tour.full-width .tour-teaser .col ul li ul.social li { font-size: 15px; padding: 5px 0; margin: 0; border: 0; background: none; -webkit-box-shadow: none; -moz-box-shadow: none; }
...
#pages.tour.full-width .tour-teaser .col ul li .user-picture { margin-top: 5px; -webkit-box-shadow: 0px 0px 7px rgba(0, 0, 0, 0.2); -moz-box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.3); width: 268px; height: 179px; }
...
#pages.tour.full-width .tour-teaser .col ul li .group .group-artwork { -webkit-box-shadow: 0px 0px 7px rgba(0, 0, 0, 0.2); -moz-box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.3); float: left; margin-right: 10px; }
#pages.tour.full-width .tour-teaser .col ul li .group .group-link { padding: 0px 14px 0 0; background-image: url(/images/bullet.png?unicorn28); background-position: 100% 2px; background-repeat: no-repeat; }
