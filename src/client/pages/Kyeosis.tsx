      ...
      <>
        ...
        <ul class={`mt-4 max-w-screen-sm`}>
          ...
          <li>
            ...
            ending in -osis, denoting a relationship to an action, process,
            state, or condition indicated by the preceding element:{' '}
            <em>hypnotic</em>; <em>neurotic</em>.
          </li>
        </ul>
        <p />
        <p />
        <BodyText>
          Using these roots <em>kyeosis</em> could be the process of being a
          Kye, or becoming a Kye. I like to think of it as developing according
          to my idealized values; as becoming who I want to be.
        </BodyText>
